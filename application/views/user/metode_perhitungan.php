      ...
      <div class="container"><br><br>
		<div class="row">
		 <div class="col-md-12">	 
          ...
          <div class="row">
            <div class="col-md-6">
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal"> Cari Data Perhitungan </button>
            </div>
          </div>
          <br>
        </div>
    ...
    <tr>
      ...
      $this->load->helper('alternatif');
        ...
        foreach ($alternatif as $key => $value) {
          if($value->jenis_aroma == $_POST['jenis_aroma']) {
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post">
          ...
          <button type="submit" name="proses" value="1" class="btn btn-success">Proses</button>
          <button type="submit" name="proses" value="2" class="btn btn-success">Hitung Semua</button>
