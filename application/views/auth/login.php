                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-5">
                        <div class="card-body">
                            ...
                            <center><img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/gambar.png" height="250" weight="250" alt=""></center><br>
                            <h5 class="mb-3 f-w-400">Jika Anda Admin Silahkan Login</h5>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        <img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/spk.png" alt="product images" class="img-fluid mb-5">
                                        <h5>Sistem Pendukung Keputusan (SPK) Parfum </h5>
                                        <p class="mb-5">Sistem pendukung keputusan pemilihan parfum</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="auth-prod-slidebg bg-2"></div>
                                    <div class="carousel-caption d-none d-md-block">
                                        <img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/metode.jpg" alt="product images" class="img-fluid mb-5">
                                        <h5>Sistem Ini Menggunakan Metode Multi Attribute Utility Theory (MAUT)</h5>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="auth-prod-slidebg bg-3"></div>
                                    <div class="carousel-caption d-none d-md-block">
                                        <img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/wallpaper.jpg" alt="product images" class="img-fluid mb-5">
                                        <h5>Memudahkan User Mengambil Keputusan Dalam Pemilihan Parfum</h5>
                                    </div>
                                </div>
